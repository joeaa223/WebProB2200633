...
<body>
    <header>
        <div class="container">
            <h1 class="header-title">Educational Learning Content</h1>
            <h2 class="header-subtitle">Welcome to the Learning center of HCS</h2>
            <div class="category-buttons">
                <a href="infographicMain.php" class="btn btn-primary">Infographic</a>
                <a href="articleMain.php" class="btn btn-primary">Article</a>
                <a href="videoMain.php" class="btn btn-primary">Video</a>
            </div>
            <a href="index1.php" class="back-to-home">Back to Homepage</a>
        </div>
    </header>
