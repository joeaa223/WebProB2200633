...
<head>
    ...
    <title>Education Content: Article</title>
...
<div class="content-overlay">
    ...
    <header>
        <div class="container">
            <!-- Site title -->
            <h1 class="text-white">Education Content: Article</h1>
            <!-- Category buttons -->
    ...
    <main>
     <div class="container">
        ...
        $sql = "SELECT * FROM tbl_content WHERE Content_type = 'article'";
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($res)) {
                ...
                echo '</td>';
                echo '<td><a href="articleFull.php?ContentID=' . $ContentID . '" class="btn btn-primary">Explore More</a></td>';
                echo '</tr>';
            }
